...
import com.appchina.rpc.thrift.server.ThriftHsHaServer;
 ...
 * */
public class ThriftHsHaServerAndClientTest {
	
	private ThriftHsHaServer server;
	
	@Before
	public void before() throws Exception {
		server = new ThriftHsHaServer();
